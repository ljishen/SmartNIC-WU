...
# https://github.com/ljishen/SmartNIC-WU/tree/main/benchmarks/pktgen_bench/README.md
...
ssh \
  ...
  sudo "\$HOME"/SmartNIC-WU/benchmarks/pktgen_bench/xmit_multiqueue.sh \
...
sudo F_THREAD=32 "$HOME"/SmartNIC-WU/benchmarks/pktgen_bench/xmit_multiqueue.sh \
